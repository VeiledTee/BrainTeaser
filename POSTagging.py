...
class SimplePOSTagger:
    def __init__(self):
        ...
        self.stanford_tagger = StanfordPOSTagger(self.stanford_pos_model, self.stanford_pos_jar,
                                                 java_options=f'-Xmx1024m', encoding='utf8')
    ...
    def filter_objects(self, tagged_sentence):
        ...
        potential_objects = [word for word, pos in tagged_sentence if pos.startswith('NN') or pos.startswith('VB')]
