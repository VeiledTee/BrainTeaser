...
# Example data
data = [
    {'question': 'What kind of nut has no shell?', 'choice_list': ['A peanut.', 'A Doughnut.', 'A walnut.', 'None of above.'], 'answer': 'A Doughnut'},
...
labels = [1 if item['choice_list'][i] == item['answer'] else 0 for item in data for i in range(len(item['choice_list']))]
